 ...
 */
    fernTree: {
        ...
        content: [
            ...
            <p> Tree ferns are found growing in tropical and subtropical areas, including cool to temperate rainforests in Australia, New Zealand and neighbouring regions (e.g. Malaysia, Lord Howe Island, etc.). Like all ferns, tree ferns reproduce by means of spores formed on the undersides of the fronds.</p>,
            // <p> The fronds of tree ferns are usually very large and multiple-pinnate. Their trunk is actually a vertical and modified rhizome, and woody tissue is absent. To add strength, there are deposits of lignin in the cell walls and the lower part of the stem is reinforced with thick, interlocking mats of tiny roots.[3] If the crown of Dicksonia antarctica (the most common species in gardens) is damaged, it will inevitably die because that is where all the new growth occurs. But other clump-forming tree fern species, such as D. squarrosa and D. youngiae, can regenerate from basal offsets or from "pups" emerging along the surviving trunk length. Tree ferns often fall over in the wild, yet manage to re-root from this new prostrate position and begin new vertical growth.</p>,
            // <p> </p>,
            // <p> </p>
        ],
